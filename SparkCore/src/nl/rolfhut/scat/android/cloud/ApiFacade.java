package nl.rolfhut.scat.android.cloud;
...
import nl.rolfhut.scat.android.cloud.api.SimpleResponse;
import nl.rolfhut.scat.android.cloud.api.TinkerResponse;
import nl.rolfhut.scat.android.cloud.requestservice.SimpleSparkApiService;
import nl.rolfhut.scat.android.smartconfig.SmartConfigState;
import nl.rolfhut.scat.android.ui.tinker.DigitalValue;
...
public class ApiFacade {
	...
	public void getVariableString(String coreName, String variable, String responseType) {
		BaseFunctionValueReceiver Receiver = new BaseFunctionValueReceiver(handler, 
				FunctionResponse.REQUEST_TYPE_VARIABLE, coreName, responseType); 
